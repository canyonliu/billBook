...
import { useCallback, useRef, useMemo, useEffect, useImperativeHandle, forwardRef, memo, useState } from 'react';
...
function Index(props, ref) {
  ...
  var typeToColumnsPlaceholderRef = useRef({});
  useEffect(function () {
    if (!_isEqual(value, valueInner)) {
      setValueInner(value);
    }
  ...
  var _renderContent = useCallback(function () {
...
var Area = /*#__PURE__*/memo( /*#__PURE__*/forwardRef(Index));
export { Area };
export default Area;