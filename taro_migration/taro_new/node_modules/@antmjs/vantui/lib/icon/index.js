...
function Icon(props) {
  var _useState = (0, _react.useState)((0, _defaultProps.get)().Icon),
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_components.View, _objectSpread(_objectSpread({
    ...
    children: [(info || info === 0 || dot) && /*#__PURE__*/(0, _jsxRuntime.jsx)(_index.Info, {
      dot: dot,
      info: info,
      className: "van-icon__info"
    }), computed.isImage(name) && /*#__PURE__*/(0, _jsxRuntime.jsx)(_components.Image, {
      src: name,
      mode: "aspectFit",
