...
function Sidebar(props) {
  var _useState = (0, _react.useState)((0, _defaultProps.get)().Sidebar),
    _useState2 = (0, _slicedToArray2.default)(_useState, 1),
    d = _useState2[0];
  var _d$props = _objectSpread(_objectSpread({}, d), props),
    activeKey = _d$props.activeKey,
  ...
  var setAction = (0, _react.useCallback)(function (activeKey) {
  ...
  var setChildren = (0, _react.useCallback)(function (index, instance) {
  ...
  var ResetChildren = (0, _react.useMemo)(function () {
    ...
    if (children && Array.isArray(children)) {
      children.forEach(function (child, index) {
        res.push( /*#__PURE__*/(0, _react.cloneElement)(child, {
          key: index,
