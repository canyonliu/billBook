...
var FormStore = /*#__PURE__*/function () {
  ...
  _createClass(FormStore, [{
    ...
    value: function notifyChange(name_, hiddenFormChange) {
      ...
      if (!hiddenFormChange) {
        ...
        if (onChange) {
          ...
          onChange(FormStore.transformMultilevelData(_defineProperty({}, name, value)), this.getFieldsValue());
        }
      }
    }
  }, {
    ...
    value: function () {
      var _validateFieldValue = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(name_) {
        var _this4 = this;
        var forceUpdate,
          name,
          model,
          ...
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              validationPromises = modelNames.map( /*#__PURE__*/function () {
                var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(modelName) {
                  var status;
