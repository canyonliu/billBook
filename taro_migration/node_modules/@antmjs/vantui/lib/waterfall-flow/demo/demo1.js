...
function Demo() {
  var genTextData = COMMON.genTextData;
  var _react$useState = _react.default.useState(genTextData('text_')),
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_vantui.WaterfallFlow, {
    dataSource: list,
    columnNum: 3,
    gutter: 4,
