...
var _formContext = _interopRequireDefault(require("./core/formContext"));
var _useForm = _interopRequireDefault(require("./core/useForm"));
...
function Index(props, ref) {
  var _useState = (0, _react.useState)((0, _defaultProps.get)().Form),
  ...
  var formInstance = (0, _useForm.default)(form, initialValues);
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  var setCallback = formInstance.setCallback,
    dispatch = formInstance.dispatch,
    formInstanceAPI = (0, _objectWithoutProperties2.default)(formInstance, _excluded);
  ...
  var RenderChildren = /*#__PURE__*/(0, _jsxRuntime.jsx)(_formContext.default.Provider, {
    value: formInstance,
    children: children
  });
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_components.Form, {
...
var Form = /*#__PURE__*/(0, _react.memo)( /*#__PURE__*/(0, _react.forwardRef)(Index));
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore
exports.Form = Form;
