...
var _excluded = ["zIndex", "offsetTop", "scrollTop", "disabled", "container", "onScroll", "style", "className", "children", "rectWrapper"];
...
function Sticky(props) {
  ...
  var _useState3 = (0, _react.useState)((0, _defaultProps.get)().Sticky),
  ...
  var getContainerRect = (0, _react.useCallback)(function () {
  ...
  var setDataAfterDiff = (0, _react.useCallback)(function (data) {
    ...
    if (Object.keys(diff).length > 0) {
      setState(function (pre) {
        return _objectSpread(_objectSpread({}, pre), diff);
      });
    }
  ...
  var onMyScroll = (0, _react.useCallback)(function (scrollTop) {
    if (disabled) {
      setDataAfterDiff({
        fixed: false,
        transform: 0
    ...
    if (typeof container === 'function') {
      Promise.all([(0, _utils2.getRect)(null, "#sticky-com-index".concat(indexRef.current), rectWrapper), getContainerRect()]).then(function (_ref) {
      ...
      (0, _utils2.getRect)(null, "#sticky-com-index".concat(indexRef.current), rectWrapper).then(function (root) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_components.View, _objectSpread(_objectSpread({
    ...
    children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_components.View, {
      ...
      style: utils.style([computed.wrapStyle({
        fixed: state.fixed,
        offsetTop: offsetTop,
