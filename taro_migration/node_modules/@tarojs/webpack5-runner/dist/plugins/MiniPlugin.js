            ...
            subPackages.forEach(item => {
                if (item.pages && item.pages.length) {
                    ...
                    item.pages.forEach(page => {
                        ...
                        if (!hasPageIn) {
                            const pagePath = (0, helper_1.resolveMainFilePath)(path_1.default.join(this.options.sourceDir, pageItem), frameworkExts);
    ...
    compileIndependentPages(compiler, compilation, dependencies, promises) {
        ...
        if (independentPackages.size) {
            ...
            independentPackages.forEach(({ pages, components }, name) => {
                ...
                const compPath = path_1.default.resolve(__dirname, '..', 'template/comp');
